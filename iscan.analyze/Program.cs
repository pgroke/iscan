...
namespace iscan.analyze
{
    ...
    ref struct DMReader
    {
        ...
        DMReader(Stream stream)
        {
            ...
            m_reader = default(Utf8JsonReader);
        ...
        DMTranslationUnit ParseTranslationUnit()
        {
            ...
            DMTranslationUnit tu = new DMTranslationUnit();
            tu.path = INT_SENTINEL;
            tu.files = null;
        ...
        DMFile ParseFile()
        {
            ...
            file.path = INT_SENTINEL;
            file.stk = INT_SENTINEL;
            file.sln = INT_SENTINEL;
            file.inc = null;
